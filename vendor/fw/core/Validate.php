...
class Validate
{
    ...
    public function checkUnique($data, $type)
    {
    ...
    public function minLength($data, $type, $int, $str = '')
    {
        if ($type !== null) {
            foreach ($data as $key => $datum) {
                if ($key == $type) {
    ...
    public function maxLength($data, $type, $int, $str = '')
    {
        if ($type !== null) {
            foreach ($data as $key => $datum) {
                if ($key == $type) {
    ...
    //проверка email
    public function checkEmail($data, $type)
    {
